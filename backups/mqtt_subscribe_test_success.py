...
MQTT_CLIENT_ID = f"home_gaming_laptop_subscriber_{uuid.uuid4().hex[:8]}"

TOPIC_SUBSCRIBE = "farm/school/room1/pico2w_001/telemetry"
...
def print_latest_payload() -> None:
    ...
    if data.get("type") == "telemetry":
        ...
        print(f"온도 temp_c  : {data.get('temp_c')}")
        print(f"습도 rh      : {data.get('rh')}")
        print(f"CO2 ppm      : {data.get('co2_ppm')}")
