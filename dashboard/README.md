...
보냅니다. 승인된 보정 세션은 설정된 시간의 A+B 주입(최대 10초) 또는 산성액 주입(최대 5초) → 30초 교반 → PE350 재측정을 목표 범위에 도달할 때까지 반복하며,
EC 1.5~2.0 또는 pH 5.5~6.5 도달, 센서 지연, EC 상한 초과, pH 하한 아래에서 즉시 끝납니다.
